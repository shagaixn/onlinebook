...
return new class extends Migration {
    public function up() {
        Schema::create('authors', function (Blueprint $table) {
            ...
            // Холбоотой хэрэглэгч (optional) - хэрвээ автор нь системийн хэрэглэгчтэй холбоотой бол
            ...
            // Нийтлэсэн/хэвлэсэн бүтээлүүд (JSON массив эсвэл текст)
            ...
            // Сошиал холбоосууд, meta жижиг тохиргоо (JSON)
