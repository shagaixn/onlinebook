...
const HeroAnimations = (() => {
  ...
  function splitToChars(el) {
    ...
    // Шугамын таслалт, span зэрэгт анхаарах: зөвхөн text node-уудыг задлах
    el.innerHTML = '';
  ...
  function setupStagger() {
    ...
    // Хэрвээ дахин render хийх бол reset() дуудах боломжтой
  }
  ...
  // Параллакс — арын gradient div-ийг бага зэрэг хөдөлгөнө
