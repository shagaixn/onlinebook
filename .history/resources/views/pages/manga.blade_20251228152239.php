...
<main class="night-sky min-h-[100svh] flex items-center justify-center px-4">
    <div class="text-center">
        ...
        <a href="{{ route('home') }}" class="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-slate-900 bg-white/10 hover:bg-slate-800 dark:hover:bg-white/20 border border-transparent dark:border-white/10 text-white transition-all duration-300 backdrop-blur-sm">
