...
<main class="night-sky min-h-[100svh] max-w-9xl mx-auto px-4 py-15">
  ...
  <section aria-label="Subscription төлөвлөгөө" class="max-w-6xl mx-auto grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
    @forelse($plans as $plan)
      <article class="group rounded-2xl bg-dark dark:bg-white/5 backdrop-blur border border-gray-200 dark:border-white/10 overflow-hidden shadow-sm hover:shadow-lg hover:border-cyan-400/40 transition p-6 flex flex-col">
        <header class="mb-4">
