...
<main class=" max-w-9xl mx-auto py-15 px-4">
  ...
  <form method="GET" action="{{ route('book') }}" class="max-w-5xl mx-auto mb-6 flex items-center gap-3 justify-center">
    ...
    <select id="category_id" name="category_id"
        class="px-4 py-3 rounded-xl bg-dark border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
