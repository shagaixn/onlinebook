...
<main class="night-sky min-h-[100svh] max-w-7xl mx-auto px-4 py-20">
  <div class="max-w-4xl mx-auto">
    ...
    <!-- Call to Action -->
    <section class="text-center bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl p-10 shadow-lg">
      <h2 class="text-3xl font-bold text-white mb-4">Манай нийгэмлэгт нэгдээрэй</h2>
      <p class="text-white/90 mb-6 max-w-2xl mx-auto">
        Мэдлэгээ баяжуулж, шинэ ертөнцүүдтэй танилцахад бэлэн үү? Бүртгүүлж, өнөөдөр эхэлцгээе.
      </p>
      <div class="flex flex-wrap justify-center gap-4">
        @guest
          <a href="{{ route('register') }}" class="px-8 py-3 bg-white text-cyan-600 rounded-full font-bold hover:bg-gray-100 transition shadow-lg">
            Бүртгүүлэх
          </a>
          <a href="{{ route('login') }}" class="px-8 py-3 bg-white/10 text-white border-2 border-white rounded-full font-bold hover:bg-white/20 transition">
            Нэвтрэх
          </a>
        @else
          <a href="{{ route('book') }}" class="px-8 py-3 bg-white text-cyan-600 rounded-full font-bold hover:bg-gray-100 transition shadow-lg">
            Номууд үзэх
          </a>
          <a href="{{ route('home') }}" class="px-8 py-3 bg-white/10 text-white border-2 border-white rounded-full font-bold hover:bg-white/20 transition">
            Нүүр хуудас
          </a>
        @endguest
      </div>
