...
<div class="min-h-screen bg-dark-50 night-sky dark:bg-[#0f172a] text-slate-900 dark:text-white pt-24 pb-12 relative overflow-hidden flex items-center justify-center">
    <div class="w-full max-w-2xl px-4 relative z-10">
        <div class="bg-dark dark:bg-slate-800/50 backdrop-blur-xl border border-gray-200 dark:border-slate-700 rounded-2xl p-12 shadow-2xl text-center">
            ...
            <p class="text-xl text-slate-700 dark:text-slate-200 mb-8">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="{{ route('login') }}" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white dark:text-white text-lg font-bold rounded-xl shadow-lg shadow-blue-900/20 transition-all hover:-translate-y-0.5">
                ...
                <a href="{{ route('register') }}" class="inline-flex items-center px-8 py-4 bg-slate-700 hover:bg-slate-600 border border-slate-600 text-white dark:text-white text-lg font-bold rounded-xl transition-all hover:-translate-y-0.5">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Back to home -->
            <div class="mt-8">
                <a href="{{ route('home') }}" class="text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 text-sm transition-colors inline-flex items-center">
