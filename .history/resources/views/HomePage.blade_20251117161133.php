...
<style>
  ...
  /* Page background using the provided image.
     Place the image at public/images/bg-grid.jpg (or change the path to your storage location) */
  .page-bg {
    font-family: 'Inter', sans-serif;
    background-image: url('{{ asset("images/homebackground.jpg") }}');
    background-size: cover;
    background-position: center;
    background-repeat: no-repeat;
    /* optional dark overlay for better contrast */
    background-color: rgba(6, 8, 23, 0.45);
