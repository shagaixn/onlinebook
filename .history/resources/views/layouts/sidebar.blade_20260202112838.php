{{-- <aside class="w-64 bg-white h-screen shadow-md fixed">
    <div class="p-6 border-b">
        <h2 class="text-2xl font-bold text-blue-600">📘 Book Plus Admin</h2>
    </div>
...
<body class="flex bg-gray-100">
    ...
    <aside class="w-64 bg-white h-screen shadow-md fixed">
        <div class="p-6 border-b">
            <a href="{{ route('admin.dashboard') }}"><h2 class="text-2xl font-bold text-blue-600">📘 Book Plus Admin</h2></a>
        </div>

        <nav class="mt-6">
            <!-- Home (public site) -->
            <a href="{{ route('home') }}" class="block px-6 py-3 text-gray-700 hover:bg-blue-100">🏠 Нүүр хуудас</a>

            <!-- Admin dashboard / chart -->
            <a href="{{ route('admin.bookchart') }}" class="block px-6 py-3 text-gray-700 hover:bg-blue-100">📊 Book chart</a>
            <a href="{{ route('admin.users.index') }}" class="block px-6 py-3 text-gray-700 hover:bg-blue-100">👥 Хэрэглэгчид</a>
            <a href="{{ route('admin.books.index') }}" class="block px-6 py-3 text-gray-700 hover:bg-blue-100">📚 Номнууд</a>
            <a href="{{ route('admin.authors.index') }}" class="block px-6 py-3 text-gray-700 hover:bg-blue-100">👥 Зохиочид </a>
