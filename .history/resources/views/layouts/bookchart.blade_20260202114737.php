...
<div class="p-8 bg-gray-100 min-h-screen">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow">
            <h3 class="text-xl font-bold mb-4 text-center">📚 Номын тархалт</h3>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-600">Категоритой ном байхгүй байна</p>
                </div>
            @endif
        </div>
        ...
        {{-- Authors Chart --}}
        <div class="bg-white p-6 rounded-2xl shadow">
            <h3 class="text-xl font-bold mb-4 text-center">✍️ Зохиолчдын номын тоо</h3>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-600">Номтой зохиолч байхгүй байна</p>
                </div>
            @endif
        </div>
    </div>
