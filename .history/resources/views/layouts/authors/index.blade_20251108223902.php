...
<div class="max-w-6xl mx-auto p-6">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('layouts.authors.create') }}" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700">
                + Шинээр нэмэх
            </a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <div class="font-semibold text-gray-800 dark:text-gray-100">
                                    <a href="{{ route('admin.authors.show', $author->slug) }}">{{ $author->name }}</a>
                                </div>
