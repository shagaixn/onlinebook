...
<div class="max-w-6xl mx-auto p-6">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-3">
            <form method="GET" class="flex items-center" action="{{ route('admin.authors.index') }}">
            ...
            <a href="{{ route('layouts.authors.create') }}" class="bg-green-600 text-white px-4 py-2 rounded">Шинэ</a>
        </div>
    </div>
