@extends('layouts.sidebar') {{-- layouts/app.blade.php гэж үзье --}}
...
<div class="max-w-7xl mx-auto py-12 px-6">
    ...
    <div>
        <p class="text-gray-600 dark:text-gray-300">
            @if(request('search'))
                '{{ request('search') }}' гэсэн үгээр хайлт хийсэн байна. 
                <a href="{{ route('authors.index') }}" class="text-blue-600 hover:underline">Бүх зохиолчдыг харах</a>
            @else
                Бүх зохиолчдыг харуулж байна.
            @endif
    </div>
            ...
            <div class="bg-white dark:bg-slate-900 shadow-lg rounded-2xl overflow-hidden hover:-translate-y-1 transition duration-200">
                ...
                <div class="p-5">
                    ...
                    <div class="mt-4 flex justify-end">
                        <a href="{{ route('admin.authors.show', $author->slug) }}" 
