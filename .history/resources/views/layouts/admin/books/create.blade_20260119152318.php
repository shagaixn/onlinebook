...
<div class="max-w-4xl mx-auto bg-white p-6 rounded-2xl shadow">
  ...
  <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
    ...
    <div>
      <label class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg"">Хэвлэгдсэн огноо</label>
    ...
    <div>
      <label class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">Зураг</label>
      @if(old('cover_image'))
        <div class="mb-3">
    ...
    <div>
      <label class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">Тайлбар</label>
