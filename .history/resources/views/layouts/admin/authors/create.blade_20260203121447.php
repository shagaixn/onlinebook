        ...
        <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <input name="birth_place" value="{{ old('birth_place') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-200 focus:border-blue-500 @error('birth_place') border-red-500 @enderror">
