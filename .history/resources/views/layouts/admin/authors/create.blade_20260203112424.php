        ...
        <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div class="relative">
                        <input type="date" name="birth_date" value="{{ old('birth_date') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-400 focus:border-blue-500 transition placeholder-gray-400 pl-10 pr-3 py-2 @error('birth_date') border-red-500 @enderror" placeholder="YYYY-MM-DD">
                ...
                <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div class="relative">
                        <input type="date" name="death_date" value="{{ old('death_date') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-400 focus:border-blue-500 transition placeholder-gray-400 pl-10 pr-3 py-2 @error('death_date') border-red-500 @enderror" placeholder="YYYY-MM-DD">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-blue-400 pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                        </span>
                    </div>
