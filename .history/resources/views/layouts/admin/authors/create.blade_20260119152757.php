 ...
 <label class="block font-medium text-gray-700 mb-1">Товч намтар</label>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div>
                    ...
                    <textarea name="notable_works_text" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-200 focus:border-blue-500 @error('notable_works_text') border-red-500 @enderror" placeholder="Ноу11&#10;Ном2&#10;Ном3">{{ old('notable_works_text') }}</textarea>
