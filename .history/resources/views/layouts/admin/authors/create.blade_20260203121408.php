       ...
       {{-- Үндсэн мэдээлэл --}}
        <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <x-form.date-field name="birth_date" label="Төрсөн огноо" :value="old('birth_date')" />
                <x-form.date-field name="death_date" label="Нас барсан огноо" :value="old('death_date')" />
                <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <label class="block font-medium text-gray-700 mb-1">Товч намтар</label>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <textarea name="notable_works_text" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-200 focus:border-blue-500 @error('notable_works_text') border-red-500 @enderror" placeholder=>{{ old('notable_works_text') }}</textarea>
                ...
                <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <textarea name="awards_text" rows="4" class="mt-1 block w-full border rounded px-3 py-2 @error('awards_text') border-red-500 @enderror" placeholder=>{{ old('awards_text') }}</textarea>
