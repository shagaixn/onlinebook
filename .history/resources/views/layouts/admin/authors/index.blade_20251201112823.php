                ...
                <div class="p-5 flex-1 flex flex-col">
                   ...
                   @if($author->birth_date)
                    ...
                    <div class="mt-4 flex justify-between items-center gap-2">
                                <a href="{{ route('authors.show', $author->slug) }}" class="text-blue-600   <a href="{{ route('admin.authors.edit', $author->id) }}" class="inline-block px-3 py-1 rounded bg-yellow-400 hover:bg-yellow-500 text-white text-xs font-semibold transition">Засах</a>
                                ...
                                </form>hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium">
                                    Дэлгэрэнгүй →
                                </a>
