...
<style>
  ...
  /* Night sky gradient */
  .page-bg {
    background: linear-gradient(to bottom, #142a66 0%, #1d3b88 35%, #274c9c 55%, #3d5faa 70%, #566bb6 78%, #7b7bc6 88%, #9f8fd4 94%, #b49edc 100%);
    position:relative;
    overflow:hidden;
    z-index:0;
    min-height:75vh;
  ...
  .page-bg::before {
    ...
    inset:0;
    background-image:
      repeating-radial-gradient(circle, rgba(255,255,255,0.9) 0 1px, transparent 1px 26px),
      repeating-radial-gradient(circle, rgba(255,255,255,0.75) 0 1px, transparent 1px 34px);
    animation: starsTwinkle 9s linear infinite;
    mix-blend-mode:screen;
    pointer-events:none;
    z-index:-1;
  }
  @keyframes starsTwinkle { 0%,100%{opacity:.95} 50%{opacity:.65} }
  @media (prefers-reduced-motion:reduce){ .page-bg::before{ animation:none; } }

  /* Clouds wrapper */
  .clouds-wrapper { position:absolute; left:0; right:0; bottom:0; height:160px; pointer-events:none; z-index:1; }
  .clouds-wrapper svg { width:100%; height:100%; display:block; }
  .clouds-wrapper .c1 { fill:#233b78; }
  .clouds-wrapper .c2 { fill:#2d4a8a; }
  .clouds-wrapper .c3 { fill:#3a599c; }
  .clouds-wrapper .c4 { fill:#4c6ab0; }
...
<main class="page-bg relative overflow-hidden">
  <!-- Clouds -->
  <div class="clouds-wrapper" aria-hidden="true">
    <svg viewBox="0 0 1440 160" preserveAspectRatio="none">
      <path class="c1" d="M0 120 Q180 60 360 120 T720 120 T1080 120 T1440 120 V160 H0Z"/>
      <path class="c2" d="M0 130 Q200 80 400 130 T800 130 T1200 130 T1440 130 V160 H0Z"/>
      <path class="c3" d="M0 140 Q220 90 440 140 T880 140 T1320 140 T1440 140 V160 H0Z"/>
      <path class="c4" d="M0 150 Q240 110 480 150 T960 150 T1440 150 V160 H0Z"/>
    </svg>
  </div>
