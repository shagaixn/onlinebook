    ...
    <div>
      ...
      @if(auth()->check() && auth()->user()->role === 'admin')
          <a href="{{ route('admin.dashboard') }}"
             class="inline-flex items-center gap-2 from-blue-600 to-blue-500 text-white py-2.5 px-5 rounded-xl hover:shadow-lg hover:shadow-blue-500/25 hover:-translate-y-0.5 transition-all duration-300 font-medium mb-4 w-full justify-center">
