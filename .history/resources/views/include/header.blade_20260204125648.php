        ...
        <div class="flex items-center justify-between gap-4 rounded-full border border-slate-200 dark:border-slate-800 bg-dark/90 dark:bg-slate-900/90 shadow-lg backdrop-blur px-4 sm:px-6 py-2.5">
          ...
          <div class="flex items-center gap-3 flex-shrink-0">
            <form action="{{ route('search') }}" method="GET" class="hidden md:block">
              <label class="sr-only" for="desktop-search">Ном эсвэл зохиолч хайх</label>
              <div class="relative">
                <input
                  id="desktop-search"
                  type="text"
                  ...
                  placeholder="Ном эсвэл зохиолч хайх..."
            ...
            @auth
              {{-- Wishlist Button --}}
              <a href="{{ url('/profile#wishlist') }}" class="hidden md:inline-flex relative text-slate-600 dark:text-slate-300 hover:text-pink-600 dark:hover:text-pink-400 transition-colors" title="Миний хадгалсан номууд">
        ...
        <div id="mobile-menu" class="hidden md:hidden fixed inset-0 z-30 bg-white/95 dark:bg-slate-950/95 backdrop-blur px-6 pt-24 pb-10">
          <div class="max-w-4xl mx-auto space-y-8">
            ...
            <div class="flex flex-wrap items-center justify-center gap-3 text-base font-semibold text-slate-800 dark:text-slate-100">
              ...
              <a href="{{ route('about') }}" class="px-4 py-2 rounded-full hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-slate-800 dark:hover:text-blue-400 {{ request()->routeIs('about') ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-slate-800' : '' }}">Бидний тухай</a>
