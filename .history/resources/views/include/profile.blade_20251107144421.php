...
<div class="max-w-4xl mx-auto mt-16 bg-dark dark:bg-slate-900 p-10 rounded-2xl shadow-2xl transition-all duration-300 transition-colors border border-transparent dark:border-slate-600 dark:border-opacity-60 dark:ring-1 dark:ring-slate-700 dark:ring-opacity-20">
    ...
    @auth
        ...
        <div class="space-y-8">
            <div class="bg-dark-50 dark:bg-slate-800 p-6 rounded-xl shadow-md hover:shadow-lg dark:shadow-none dark:hover:shadow-lg transition-shadow dark:border dark:border-slate-700 dark:border-opacity-30">
