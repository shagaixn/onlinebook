...
<script>
  document.getElementById('dark-toggle').onclick = function() {
   ...
   <nav class="max-w-7xl mx-auto px-8 mt-4 flex items-center gap-8 text-gray-700 dark:text-gray-300 font-medium">
      ...
      <a href="" class="nav-link px-2 py-1 rounded-full transition-colors hover:bg-blue-50 hover:text-blue-600 dark:hov er:bg-slate-800 dark:hover:text-blue-400">Зохиолчид</a>
    </nav>
