    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
            <div>
                ...
                <p class="text-slate-400 mt-2">Таны хувийн мэдээлэл болон тохиргоо</p>
            </div>
            <div class="flex gap-3">
                 <a href="{{ url('/profile/edit') }}" class="px-4 py-2 bg-blue-600 hover:bg-blue-500 rounded-lg font-medium transition-all flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                    Засах
                </a>
                <a href="{{ route('profile.changePasswordForm') }}" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 border border-slate-600 rounded-lg font-medium transition-all flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                    Нууц үг
                </a>
                <form action="{{ route('logout') }}" method="POST" class="inline">
                    @csrf
                    <button type="submit" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 border border-slate-600 rounded-lg font-medium transition-all flex items-center gap-2">
        ...
        @auth
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-6">
                    <!-- User Card -->
                    <div class="bg-slate-800/50 backdrop-blur-xl border border-slate-700 rounded-2xl p-6 text-center relative overflow-hidden group">
