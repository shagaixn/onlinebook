  ...
  <div class="border-t border-gray-100 dark:border-slate-800 py-6">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-8">
      ...
      <div class="flex space-x-4">
        ...
        <a href="https://www.instagram.com/portgas_d_shagai/" class="text-gray-500 dark:text-gray-400 hover:text-pink-500 dark:hover:text-pink-400 text-xl"><i class="fab fa-instagram"></i></a>
