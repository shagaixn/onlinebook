...
<div class="min-h-screen bg-dark-50 night-sky dark:bg-[#0f172a] text-slate-900 dark:text-white pt-24 pb-12 relative overflow-hidden flex items-center justify-center">
    ...
    <div class="w-full max-w-md px-4 relative z-10">
        <div class="bg-dark dark:bg-slate-800/50 backdrop-blur-xl border border-gray-200 dark:border-slate-700 rounded-2xl p-8 shadow-2xl">
            ...
            @if(session('warning') || session('message'))
                <div class="mb-6 p-4 bg-yellow-500/10 border border-yellow-500/50 rounded-xl">
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-yellow-200 dark:text-yellow-300 font-medium mb-2">
                                {{ session('warning') ?? session('message') }}
                            </p>
                            <a href="{{ route('login') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/>
                                </svg>
                                Нэвтрэх хэсэгт очих
                            </a>
                            <a href="{{ route('register') }}" class="inline-flex items-center px-4 py-2 ml-2 bg-slate-700 hover:bg-slate-600 text-white text-sm font-medium rounded-lg transition-colors">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-8">
                ...
                <p class="mt-8 text-center text-sm dartk:text-slate-400">
                    Бүртгэлгүй юу? 
