    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between px-8">
      ...
      <form class="relative" action="{{ route('book') }}" method="GET">
        <input
          ...
          aria-label="Ном хайх"
        >
        <button type="submit" class="absolute right-2 top-1/1 -translate-y-1/3 text-gray-400 dark:text-gray-400 hover:text-blue-500 transition-colors" aria-label="Хайх">
