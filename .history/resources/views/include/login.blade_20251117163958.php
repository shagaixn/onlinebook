...
<section class="relative min-h-[80vh] flex items-center justify-center px-4 py-12 bg-gradient-to-br from-slate-50 to-indigo-50 dark:from-slate-950 dark:to-slate-900">
    ...
    <div id="auth-card" class="w-full max-w-md bg-da dark:bg-slate-900/70 backdrop-blur-xl p-8 rounded-2xl shadow-xl transition-colors duration-200 border border-slate-200/70 dark:border-slate-700/70">
