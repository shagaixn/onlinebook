      ...
      <form method="POST" action="{{ route('login') }}" novalidate class="space-y-4" aria-describedby="login-desc">
        ...
        <div class="pt-2">
          ...
          <div class="mt-3 grid grid-cols-3 gap-3">
            ...
            <a href="" class="icon-btn w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-100 text-sm hover:shadow-sm transition" aria-label="Facebook-ээр нэвтрэх">
              <!-- Facebook SVG -->
            ...
            <a href="" class="icon-btn w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-100 text-sm hover:shadow-sm transition" aria-label="Twitter-ээр нэвтрэх">
            ...
            <a href="" class="icon-btn w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-100 text-sm hover:shadow-sm transition" aria-label="Google-ээр нэвтрэх">
