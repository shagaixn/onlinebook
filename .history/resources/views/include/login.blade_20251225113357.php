...
<div class="min-h-screen bg-[#0f172a] text-white pt-24 pb-12 relative overflow-hidden flex items-center justify-center">
    <!-- Background Elements -->
    ...
    <div class="w-full max-w-md px-4 relative z-10">
        <div class="bg-slate-800/50 backdrop-blur-xl border border-slate-700 rounded-2xl p-8 shadow-2xl">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400 mb-2">
                    Нэвтрэх
                </h1>
                <p class="text-slate-400">Book Plus-д дахин тавтай морил!</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    <label for="email" class="block text-sm font-medium text-slate-300 mb-2">Имэйл</label>
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email" required autofocus
                               class="w-full pl-10 pr-4 py-3 bg-slate-900/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-slate-300 mb-2">Нууц үг</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg class="h-5 w-5 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <input type="password" name="password" id="password" required
                               class="w-full pl-10 pr-10 py-3 bg-slate-900/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
                               placeholder="••••••••">
                ...
                <button type="submit" class="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white rounded-xl font-bold shadow-lg shadow-blue-900/20 transition-all hover:-translate-y-0.5">
                    Нэвтрэх
                </button>
            </form>
            ...
            <div class="mt-8">
                ...
                <div class="mt-6 grid grid-cols-3 gap-4">
                    <a href="#" class="flex items-center justify-center py-2.5 border border-slate-700 rounded-xl hover:bg-slate-700/50 transition-colors group">
