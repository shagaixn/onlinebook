  ...
  <div class="relative max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 text-sm">
    ...
    <div class="lg:col-span-2">
      <div class="flex items-center gap-2 mb-6">
        <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center text-white dark:text-white  font-bold text-xl shadow-lg shadow-blue-500/20">
          B
        </div>
