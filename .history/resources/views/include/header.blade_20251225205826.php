...
<script id="theme-init">
  ...
  <style>
    ...
    /* Force override tailwind colors in light mode if needed, but usually body color inherits unless overridden. 
       If we want to be strict: */
    :not(.dark) [class*="text-slate-"],
    :not(.dark) [class*="text-gray-"],
    :not(.dark) [class*="text-zinc-"],
    :not(.dark) [class*="text-neutral-"],
    :not(.dark) [class*="text-stone-"] {
    ...
    /* Force override tailwind colors in dark mode */
