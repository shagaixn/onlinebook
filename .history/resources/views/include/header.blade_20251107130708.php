...
<script>
  document.getElementById('dark-toggle').onclick = function() {
    ...
    <a href="#" class="flex items-center gap-2 px-5 py-2 rounded-full border-2 border-white text-white bg-[#0545a3] font-medium transition-all duration-150 shadow-sm">
