...
<div class="max-w-4xl mx-auto mt-16 bg-dark dark:bg-slate-900 p-10 rounded-2xl shadow-2xl transition-all duration-300 transition-colors border border-transparent dark:border-slate-800">
