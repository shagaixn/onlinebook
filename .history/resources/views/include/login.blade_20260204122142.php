            ...
            @if(session('message'))
                <div class="mb-6 p-4 bg-yellow-500/10 border border-yellow-500/50 rounded-xl">
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-yellow-200 dark:text-yellow-300">{{ session('message') }}</p>
                            <a href="{{ route('register') }}" class="inline-block mt-2 text-sm text-blue-400 hover:text-blue-300 font-medium transition-colors">
                                → Шинээр бүртгүүлэх
                            </a>
                        </div>
                    </div>
