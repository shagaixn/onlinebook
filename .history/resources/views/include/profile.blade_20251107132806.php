...
<div class="max-w-4xl mx-auto mt-16 bg-white dark:bg-slate-900 p-10 rounded-2xl shadow-2xl transition-all duration-300 border border-transparent dark:border-slate-800">
    ...
    @auth
        ...
        <div class="space-y-8">
            <div class="bg-gray-50 dark:bg-slate-800 p-6 rounded-xl shadow-md hover:shadow-lg dark:shadow-none dark:hover:shadow-lg transition-shadow">
