...
<div class="max-w-md mx-auto mt-16 bg-dark dark:bg-slate-900 p-8 rounded shadow transition-colors duration-200 border border-transparent border-gray-200 dark:border-slate-700">
