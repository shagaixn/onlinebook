...
<div class="min-h-screen bg-dark-50 dark:bg-[#0f172a] text-slate-900 dark:text-white pt-24 pb-12 relative overflow-hidden flex items-center justify-center">
    ...
    <div class="w-full max-w-md px-4 relative z-10">
        <div class="bg-dark dark:bg-slate-800/50 backdrop-blur-xl border border-gray-200 dark:border-slate-700 rounded-2xl p-8 shadow-2xl">
            {{-- Error alert --}}
            @if(session('error'))
              <div class="mb-4 rounded-xl border border-red-300/60 bg-red-50 text-red-700 dark:border-red-500/40 dark:bg-red-900/40 dark:text-red-200 px-4 py-3 text-sm">
                {{ session('error') }}
              </div>
            @endif
            ...
            <div class="mt-8">
                ...
                <div class="mt-6 grid grid-cols-3 gap-4">
                    <a href="{{ route('social.redirect', 'facebook') }}" aria-label="Facebook-ээр нэвтрэх" class="flex items-center justify-center py-2.5 border border-slate-700 rounded-xl hover:bg-slate-700/50 transition-colors group"> 24">
