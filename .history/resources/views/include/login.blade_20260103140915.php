    ...
    <div class="w-full max-w-md px-4 relative z-10">
        <div class="bg-dark dark:bg-slate-800/50 backdrop-blur-xl border border-gray-200 dark:border-slate-700 rounded-2xl p-8 shadow-2xl">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <button type="submit" class="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-900 dark:text-slate-400 rounded-xl font-bold shadow-lg shadow-blue-900/20 transition-all hover:-translate-y-0.5">
                    Нэвтрэх
                </button>
            </form>
