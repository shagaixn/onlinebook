...
<div class="max-w-md mx-auto mt-16 bg-dark dark:bg-slate-900 p-8 rounded shadow transition-colors border-gray-200 duration-200 border border-transparent  dark:border-slate-700">
