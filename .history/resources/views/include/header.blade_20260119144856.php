...
<body class="bg-gradient-to-b from-[#f6f9ff] to-white dark:from-slate-950 dark:to-slate-900 min-h-screen text-black dark:text-white">
  ...
  <header class="sticky top-0 z-50 px-4 pt-5 pb-3 bg-transparent">
    <div class="max-w-screen-xl mx-auto">
      <div class="relative">
        <div class="flex items-center justify-between gap-4 rounded-full border border-slate-200 dark:border-slate-800 bg-dark/90 dark:bg-slate-900/90 shadow-lg backdrop-blur px-4 sm:px-6 py-2.5">
          <div class="flex items-center gap-4 min-w-0">
          ...
          </div><span aria-hidden="true" class="h-8 w-px bg-slate-200 dark:bg-slate-700"></span>
            ...
            <div class="hidden md:flex items-center gap-1 text-sm font-semibold text-slate-700 dark:text-slate-200">
              ...
              <a href="{{ route('categories.index') }}" class="px-3 py-1.5 rounded-full hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-slate-800 dark:hover:text-blue-400 {{ request()->routeIs('categories.*') ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-slate-800' : '' }}">Ангилал</a>
          ...
          <div class="flex items-center gap-3 flex-shrink-0">
            <form action="{{ route('book') }}" method="GET" class="hidden md:block">
              <label class="sr-only" for="desktop-search"> хайх</label>
              <div class="relative">
                <input
                  id="desktop-search"
                  type="text"
                  ...
                  aria-label=" хайх"
                >
                <button type="submit" class="absolute left-3 top-1/4 -translate-y-2/2 text-slate-500 hover:text-blue-600 dark:text-slate-300 dark:hover:text-blue-400">
          ...
          <div class="max-w-4xl mx-auto space-y-8">
            <form class="relative" action="{{ route('book') }}" method="GET">
              <input
                ...
                placeholder="Номын нэр эсвэл зохиолч..."
                aria-label="Ном эсвэл зохиолч хайх"
              >
            ...
            <div class="flex flex-wrap items-center justify-center gap-3 text-base font-semibold text-slate-800 dark:text-slate-100">
              ...
              <a href="{{ route('authors.index') }}" class="px-4 py-2 rounded-full hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-slate-800 dark:hover:text-blue-400 {{ request()->routeIs('authors.index') ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-slate-800' : '' }}">Зохиолчид</a>
                <a href="{{ route('categories.index') }}" class="px-4 py-2 rounded-full hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-slate-800 dark:hover:text-blue-400 {{ request()->routeIs('categories.*') ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-slate-800' : '' }}">Ангилал</a>
