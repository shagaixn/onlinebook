...
<!-- Navigation Bar -->
<nav class="flex gap-8 px-8 py-3 bg-[#0545a3]">
    <a href="#" class="flex items-center gap-2 px-5 py-2 rounded-full border-2 border-white text-white bg-[#0545a3] font-medium transition-all duration-150 shadow-sm hover:bg-white hover:text-[#0545a3] active:bg-white active:text-[#0545a3]">
        <i class="fa-solid fa-bed text-xl"></i>
        <span class="text-lg">Stays</span>
    </a>
    <a href="#" class="flex items-center gap-2 px-5 py-2 rounded-full text-white font-medium transition-all duration-150 hover:bg-white hover:text-[#0545a3]">
        <i class="fa-solid fa-plane-departure text-xl"></i>
        <span class="text-lg">Flights</span>
    </a>
    <a href="#" class="flex items-center gap-2 px-5 py-2 rounded-full text-white font-medium transition-all duration-150 hover:bg-white hover:text-[#0545a3]">
        <i class="fa-solid fa-car text-xl"></i>
        <span class="text-lg">Car rental</span>
    </a>
    <a href="#" class="flex items-center gap-2 px-5 py-2 rounded-full text-white font-medium transition-all duration-150 hover:bg-white hover:text-[#0545a3]">
    ...
    <a href="#" class="flex items-center gap-2 px-5 py-2 rounded-full text-white font-medium transition-all duration-150 hover:bg-white hover:text-[#0545a3]">
        ...
        <span class="text-lg">Airport taxis</span>
    </a>
</nav>
