    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between px-8">
      ...
      <form class="relative" action="{{ route('book') }}" method="GET">
        <input
          ...
          aria-label="Ном хайх"
        >
        <button type="submit" class="absolute left-3 top-1/3.2 -translate-y-2/2 text-gray-400 dark:text-gray-400 hover:text-blue-500 transition-colors" aria-label="Хайх">
