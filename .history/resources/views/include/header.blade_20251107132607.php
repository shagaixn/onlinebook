...
<head>
  ...
  <style>
    ...
    /* Added: footer styles with dark-mode support */
    .site-footer {
      background: #f8fafc;
      color: #374151;
    ...
    .site-footer .muted { color: #6b7280; font-size: .95rem; }
    ...
    .dark .site-footer a { color: #60a5fa; }
    .dark .site-footer a:hover { color: #93c5fd; }
    .dark .site-footer .muted { color: #9ca3af; }
  </style>
  @stack('head')
</head>
