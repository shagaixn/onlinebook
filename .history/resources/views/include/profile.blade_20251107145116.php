    ...
    @auth
        ...
        <div class="space-y-8">
            ...
            <div class="flex justify-center flex-wrap gap-4">
                ...
                <!-- Added: Authors page link -->
                <a href="{{ route('authors.index') }}"
                   class="bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-600 dark:hover:bg-indigo-500 text-white px-6 py-2.5 rounded-lg shadow transition-transform hover:-translate-y-0.5">
                    📚 Авторууд
                </a>
