...
<section class="relative min-h-[80vh] flex items-center justify-center px-4 py-12 bg-gradient-to-br from-slate-50 to-indigo-50 dark:from-slate-950 dark:to-slate-900">
    ...
    <div id="auth-card" class="w-full max-w-md bg-white/80 dark:bg-slate-900/70 backdrop-blur-xl p-8 rounded-2xl shadow-xl transition-colors duration-200 border border-slate-200/70 dark:border-slate-700/70">
        <div class="text-center mb-6">
            <h2 class="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">Нэвтрэх</h2>
