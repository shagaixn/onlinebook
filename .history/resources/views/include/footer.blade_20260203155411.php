...
<footer class="site-footer relative mt-24 border-t border-gray-200 dark:border-white/10 bg-dark dark:bg-[#0f172a] text-slate-600 dark:text-slate-300 overflow-hidden">
  ...
  B
      ...
      <div class="flex gap-4">
        <a href="https://www.facebook.com/" class="w-10 h-10 rounded-full bg-dark-100 dark:bg-white/5 text-slate-500 dark:text-slate-400 hover:bg-blue-600 hover:text-white flex items-center justify-center transition-all duration-300" aria-label="Facebook">
          <i class="fab fa-facebook-f"></i>
        </a>
        <a href="https://www.instagram.com/portgas_d_shagai/" class="w-10 h-10 rounded-full  bg-dark-100 dark:bg-white/5 text-slate-500 dark:text-slate-400 hover:bg-pink-600 hover:text-white flex items-center justify-center transition-all duration-300" aria-label="Instagram">
          <i class="fab fa-instagram"></i>
        </a>
        <a href="#" class="w-10 h-10 rounded-full  bg-dark-100 dark:bg-white/5 text-slate-500 dark:text-slate-400 hover:bg-red-600 hover:text-white flex items-center justify-center transition-all duration-300" aria-label="YouTube">
          <i class="fab fa-youtube"></i>
        </a>
        <a href="#" class="w-10 h-10 rounded-full bg-dark-100 dark:bg-white/5 text-slate-500 dark:text-slate-400 hover:bg-blue-500 hover:text-white flex items-center justify-center transition-all duration-300" aria-label="LinkedIn">
    ...
    <div>
      <h3 class="font-bold text-white-900 dark:text-white text-lg mb-6">Бүтээл нийтлэх</h3>
      @if(auth()->check() && auth()->user()->role === 'admin')
          <a href="{{ route('admin.dashboard') }}"
             class="inline-flex items-center gap-2 from-blue-600 to-blue-500 text-dark py-2.5 px-5 rounded-xl hover:shadow-lg hover:shadow-blue-500/25 hover:-translate-y-0.5 transition-all duration-300 font-medium mb-4 w-full justify-center">
