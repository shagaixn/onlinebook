...
<div class="min-h-screen bg-slate-100 dark:bg-[#0f172a] text-slate-900 dark:text-white pt-24 pb-12 relative overflow-hidden">
    <!-- Background Elements -->
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
            ...
            <div class="flex gap-3">
                 <button type="button" id="theme-toggle" onclick="toggleTheme()" class="px-4 py-2 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 border border-slate-300 dark:border-slate-600 text-slate-800 dark:text-white rounded-lg font-medium transition-all flex items-center gap-2">
                    <svg class="w-4 h-4 text-yellow-600 dark:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v2m0 14v2m7-9h2M3 12H1m15.364 6.364l1.414 1.414M6.222 6.222L4.808 4.808m12.728 0l1.414 1.414M4.808 19.192l1.414-1.414M12 8a4 4 0 100 8 4 4 0 000-8z"></path></svg>
                    <svg class="w-4 h-4 hidden dark:inline text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 118.646 3.646 7 7 0 0020.354 15.354z"></path></svg>
                    Theme
                 </button>
        ...
        @auth
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <!-- Subscription Status -->
                    <div class="bg-white dark:bg-gradient-to-br dark:from-indigo-900/50 dark:to-purple-900/50 backdrop-blur-xl border border-indigo-200 dark:border-indigo-500/30 rounded-2xl p-6 relative overflow-hidden">
                        ...
                        <div class="mb-4">
                            <div class="text-sm text-indigo-700 dark:text-indigo-200 mb-1">Төлөв</div>
                            <div class="text-xl font-bold text-slate-900 dark:text-white">Идэвхгүй</div>
                        </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    <!-- Personal Info -->
                    <div class="bg-white dark:bg-slate-800/50 backdrop-blur-xl border border-slate-200 dark:border-slate-700 rounded-2xl p-6">
                    ...
                    <div class="bg-white dark:bg-slate-800/50 backdrop-blur-xl border border-slate-200 dark:border-slate-700 rounded-2xl p-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-4 p-4 rounded-xl bg-slate-50 dark:bg-slate-900/30 border border-slate-200 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600 transition-colors">
                                <div class="w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                </div>
                                <div>
                                    <p class="text-slate-800 dark:text-slate-200 text-sm">Бүртгэл үүсгэсэн</p>
