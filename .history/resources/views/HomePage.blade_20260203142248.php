...
<style>
  ...
  .hero-logo-shell {
    ...
    background: radial-gradient(circle at 30% 30%, rgba(255, 255, 255, 0.9), rgba(255, 255, 255, 0.15)),
                linear-gradient(135deg, #f97316, #e11d48, #8b5cf6);
    display: flex;
  ...
  .hero-logo-ring {
    ...
    opacity: 0.5;
    animation: hero-glow 9s ease-in-out infinite reverse;
  }
  ...
  <section class="w-full min-h-[100svh] flex flex-col justify-center items-center px-4 relative z-10 overflow-hidden">
    ...
    <div class="flex justify-center mb-12">
      <div class="hero-logo-wrapper">
        ...
        <div class="hero-logo-spark"></div>
        <div class="hero-logo-shell">
          <span class="hero-logo-text">Book</span>
          <span class="hero-logo-text">Plus</span>
          <span class="hero-logo-text-accent">read</span>
        </div>
      </div>
    </div>
