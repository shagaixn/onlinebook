...
<main class="night-sky min-h-[100svh] flex items-center justify-center px-4">
    <div class="text-center">
        ...
        <h1 class="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Podcast</span>
        </h1>
        ...
        <a href="{{ route('home') }}" class="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 hover:bg-white/20 border border-white/10 text-white transition-all duration-300 backdrop-blur-sm">
