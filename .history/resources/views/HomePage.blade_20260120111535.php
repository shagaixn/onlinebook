...
<main class="night-sky min-h-[100svh] max-w-9xl mx-auto px-4 py-15">
  ...
  <section class="max-w-4xl mx-auto px-6 pt-32 pb-24 text-center relative z-10">
    ...
    <div class="relative w-full h-[350px] md:h-[450px] mt-8 mb-12 flex justify-center items-center overflow-hidden">
      {{-- Circular Orbit Container --}}
      <canvas id="authors-canvas" class="absolute inset-0 w-full h-full pointer-events-none"></canvas>
      
      <div id="authors-orbit" class="relative w-[280px] h-[280px] md:w-[400px] md:h-[400px] rounded-full border border-gray-200/20 dark:border-white/5 bg-white/5 backdrop-blur-sm shadow-[0_0_40px_rgba(0,0,0,0.08)] dark:shadow-[0_0_40px_rgba(255,255,255,0.04)] transition-all duration-1000">
        {{-- Central Text/Logo --}}
