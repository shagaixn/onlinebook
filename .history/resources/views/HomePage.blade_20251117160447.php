...
<main class="relative min-h-[60vh] overflow-hidden bg-fixed" style="background-image:url('{{ asset('images/home-grid.jpg') }}'); background-size:cover; background-position:center;">
