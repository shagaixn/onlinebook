...
<main class="relative min-h-[60vh] overflow-hidden bg-fixed" style="background-image:url('{{ asset('images/downlaod.jpg') }}'); background-size:cover; background-position:center;">
