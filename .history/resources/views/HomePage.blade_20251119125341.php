...
<style>
  ...
  .page-bg::before {
    ...
    animation: moveStars1 var(--stars1-speed) linear infinite;
    opacity: var(--stars1-opacity);
    pointer-events: none;
    z-index: -3;
  ...
  @keyframes moveStars1 {
    ...
    to { transform: translate(var(--driftX1), 600px); }
  }
  ...
  .page-bg::after {
    ...
    animation: moveStars2 var(--stars2-speed) linear infinite;
    opacity: var(--stars2-opacity);
    pointer-events: none;
    z-index: -1;
    will-change: transform;
  }
  ...
  @keyframes moveStars2 {
    from { transform: translate(0, 0); }
    to { transform: translate(var(--driftX2), 800px); }
  }
  ...
  .stars-3 {
    position: absolute;
    inset: 0;
    background-image: repeating-radial-gradient(circle, white 0 2px, transparent 2px  28px);
    animation: moveStars3 var(--stars3-speed) linear infinite;
    opacity: var(--stars3-opacity);
    pointer-events: none;
    z-index: -2;
    will-change: transform;
  }
  ...
  @keyframes moveStars3 {
    from { transform: translate(0, 0); }
    to { transform: translate(var(--driftX3), 1000px); }
  }
...
<main class="page-bg relative min-h-[60vh] overflow-hidden">
  ...
  <!-- Middle star layer (layer 3) -->
  <div aria-hidden="true" class="stars-3"></div>
