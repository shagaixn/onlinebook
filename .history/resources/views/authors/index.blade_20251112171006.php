...
<div class="max-w-7xl mx-auto px-6 py-10">
    ...
    <form method="GET" action="{{ route('authors.index') }}" class="mb-6 flex gap-3">
        <input type="text" name="q" value="{{ request('q') }}" placeholder="Нэр эсвэл танилцуулга..."
                     class="flex-2 px-4 py-2 rounded-xl border border-gray-200 dark:border-slate-70 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500" />
