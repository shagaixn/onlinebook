      ...
      <div class="p-8 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="space-y-6 md:col-span-2">
          ...
          @if($author->birth_date || $author->death_date)
            <div class="flex items-center gap-4 p-4 bg-gray-50 dark:bg-white/10 border border-gray-200 dark:border-white/10 rounded-xl mb-3">
              <span class="text-2xl inline-block bg-white dark:bg-white/10 text-slate-900 dark:text-white w-12 h-12 rounded-full flex items-center justify-center border border-gray-200 dark:border-white/20">📅</span>
              <div>
