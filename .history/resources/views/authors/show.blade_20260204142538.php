            ...
            <div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                @foreach($books as $book)
                  <div class="block p-4 bg-dark dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg hover:bg-blue-500 dark:hover:bg-white/10 transition">
