        ...
        <div class="p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                @endif
                    ...
                    <div class="mt-5 text-gray-800 dark:text-gray-100 whitespace-pre-line leading-7"></div>
                ...
                @if(!empty($awards))
                    {{-- <div class="mt-6">
                        <h2 class="text-lg font-semibold text-slate-900 dark:text-white mb-2">Шагнал/Бүтээлүүд</h2>
