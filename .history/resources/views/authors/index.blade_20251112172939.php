    ...
    @else
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            @foreach($authors as $author)
                <a href="{{ route('authors.show', $author->slug) }}" class="block bg-dark dark:bg-slate-900 rounded-2xl shadow hover:shadow-lg border border-gray-100 dark:border-slate-800 overflow-hidden hover:-translate-y-0.5 transition">
