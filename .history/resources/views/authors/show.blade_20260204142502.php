            ...
            <div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3">
                @foreach($notableWorks as $work)
                  <div class="flex items-center gap-3 p-3 bg-dark dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg hover:bg-blue-100 dark:hover:bg-white/10 transition">
