            ...
            <div class="flex items-center gap-4 p-4 bg-dark dark:bg-white/10 border border-gray-200 dark:border-white/10 rounded-xl mb-3">
              ...
              <div>
                ...
                <div class="font-semibold text-slate-900 dark:text-white">
                  {{ $author->birth_date ?? 'Тодорхойгүй' }} —
                  {{ $author->death_date ?? 'Одоо' }}
                </div>
              </div>
            </div>
          @endif
            ...
            <div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3">
                @foreach($notableWorks as $work)
                  <div class="flex items-center gap-3 p-3 bg-dark dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg hover:bg-blue-500 dark:hover:bg-white/10 transition">
            ...
            <div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                @foreach($books as $book)
                  <div class="block p-4 bg-dark dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg hover:bg-blue-100 dark:hover:bg-white/10 transition">
                    <div class="flex gap-3">
                      ...
                      <div class="flex-1">
                        <h3 class="font-semibold mb-1">
                          <a href="{{ route('books.show', $book->id) }}" class="text-blue-600 dark:text-blue-300 hover:text-blue-800 dark:hover:text-blue-100 underline underline-offset-2">
                            {{ $book->title }}
                          </a>
                        </h3>
