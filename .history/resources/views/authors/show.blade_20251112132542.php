...
<div class="max-w-3xl mx-auto mt-16 p-6 text-gray-100">
    ...
    <div class="bg-slate-800 p-8 rounded-2xl shadow-lg flex flex-col items-center">
        <img src="{{ $authors->avatar ? Storage::disk('public')->url($author->avatar) : '/images/authors/default.jpg' }}" alt="Author" class="w-32 h-32 rounded-full mb-4 object-cover border-2 border-blue-500">
