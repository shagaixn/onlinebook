...
<main class="relative min-h-[60vh] overflow-hidden bg-fixed" style="background-image:url('{{ asset('images/downlaod (1).jpg') }}'); background-size:cover; background-position:center;">
  <!-- Background overlay for readability -->
  <div class="absolute inset-0 bg-gradient-to-b from-slate-900/70 via-slate-900/50 to-slate-900/80 dark:from-slate-950/75 dark:via-slate-900/65 dark:to-slate-950/85 pointer-events-none -z-10"></div>
  <!-- (Removed circular decorations; replaced by image background) -->
  ...
  <div class="relative mx-auto mt-6 w-full max-w-xl h-72 sm:h-80">
    ...
    @if($circleBooks->count())
      ...
      @endforeach
    @else
  <img src="{{ asset('images/placeholder-book.png') }}" alt="Placeholder ном 1" loading="lazy" decoding="async" class="absolute top-4 left-6 w-20 h-20 sm:w-24 sm:h-24 rounded-xl object-cover shadow-lg ring-1 ring-black/5 float-slow" />
  <img src="{{ asset('images/placeholder-book.png') }}" alt="Placeholder ном 2" loading="lazy" decoding="async" class="absolute top-8 right-6 w-20 h-20 sm:w-24 sm:h-24 rounded-xl object-cover shadow-lg ring-1 ring-black/5 float-slow" style="animation-delay:.6s" />
  <img src="{{ asset('images/placeholder-book.png') }}" alt="Placeholder ном 3" loading="lazy" decoding="async" class="absolute bottom-6 left-1/2 -translate-x-1/2 w-20 h-20 sm:w-24 sm:h-24 rounded-xl object-cover shadow-lg ring-1 ring-black/5 float-slow" style="animation-delay:1.2s" />
    @endif
