...
<main class="night-sky min-h-[100svh] max-w-9xl mx-auto px-4 py-16 animate-fade-in">
  ...
  <section class="relative max-w-5xl mx-auto px-6 pt-24 pb-16 text-center z-10">
    ...
    <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
      @if($isAuthenticated)
        <a href="{{ route('subscription') }}" class="px-8 py-4 rounded-full bg-white text-slate-900 font-bold hover:scale-105 transition shadow-lg focus:outline-none focus:ring-2 focus:ring-cyan-400">
          Subscription →
        </a>
      @else
        <a href="{{ route('login') }}" class="px-8 py-4 rounded-full bg-white text-slate-900 font-bold hover:scale-105 transition shadow-lg focus:outline-none focus:ring-2 focus:ring-cyan-400">
          Нэвтрэх →
        </a>
      @endif
      
      <a href="{{ route('book') }}" class="px-8 py-4 rounded-full bg-white/10 text-white border border-white/30 backdrop-blur hover:bg-white/20 transition focus:outline-none focus:ring-2 focus:ring-cyan-400">
        Номуудыг үзэх
      </a>
    </div>
  </section>
  ...
  <section class="max-w-6xl mx-auto px-6 mt-24">
    ...
    <div class="flex overflow-x-auto gap-6 pb-8 scrollbar-hide snap-x" role="region" aria-label="Top rated books carousel">
