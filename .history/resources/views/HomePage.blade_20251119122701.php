...
<style>
  ...
  .page-bg {
  background: #0b1120; /* dark-slate-like base */
  position: relative;
  overflow: hidden;
}
...
.page-bg::before {
  ...
  position: absolute;
  inset: 0;
  background: radial-gradient(2px 2px at 20% 30%, white 60%, transparent),
              radial-gradient(1.5px 1.5px at 70% 20%, white 60%, transparent),
              radial-gradient(1.2px 1.2px at 40% 80%, white 60%, transparent),
              radial-gradient(1.5px 1.5px at 85% 60%, white 60%, transparent),
              radial-gradient(1px 1px at 30% 70%, white 60%, transparent),
              radial-gradient(1px 1px at 60% 50%, white 60%, transparent);
  opacity: 0.35;
}

/* Twinkle animation layer */
@keyframes twinkle {
  0%, 100% { opacity: .3; }
  50% { opacity: .7; }
}
.page-bg::after {
  ...
  position: absolute;
  inset: 0;
  background: radial-gradient(1.5px 1.5px at 25% 40%, white, transparent),
              radial-gradient(1px 1px at 75% 75%, white, transparent),
              radial-gradient(1.2px 1.2px at 55% 30%, white, transparent);
