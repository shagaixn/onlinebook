    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
      @forelse($featuredAuthors as $author)
        <a href="{{ route('authors.show', $author->slug ?? $author->id) }}" 
          ...
          <div class="w-16 h-16 mx-auto rounded-full overflow-hidden border border-gray-200 dark:border-gray-700 mb-3 group-hover:border-gray-400 dark:group-hover:border-gray-500 transition-colors">
            <img 
      ...
      @empty
        <div class="col-span-full text-center py-16 text-gray-500">Зохиолч байхгүй байна.</div>
      @endforelse
    </div>
  </section>
