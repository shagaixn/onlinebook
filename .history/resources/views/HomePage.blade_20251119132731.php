...
{{-- Vector night sky style (Image #4-like) --}}
<style>
  ...
  /* New night sky gradient (dark top -> violet bottom) */
  .page-bg {
    position:relative;
    min-height:75vh;
    overflow:hidden;
  ...
  /* Stars layer: static vector dots (pseudo) */
  .page-bg::before {
    content:"";
    position:absolute;
    inset:0;
  ...
  /* Bottom layered clouds (vector style) */
  /* .page-bg::after {
    content:"";
    position:absolute;
    ...
    z-index:1;
    background:
      radial-gradient(circle at 8% 100%,  #1c2e55 0 31%, transparent 32%),
      radial-gradient(circle at 22% 105%, #1d335f 0 33%, transparent 34%),
      radial-gradient(circle at 36% 100%, #203965 0 30%, transparent 31%),
      radial-gradient(circle at 50% 106%, #223d6c 0 35%, transparent 36%),
      radial-gradient(circle at 64% 101%, #1f3661 0 31%, transparent 32%),
      radial-gradient(circle at 78% 104%, #1c2e55 0 33%, transparent 34%),
      radial-gradient(circle at 92% 100%, #182846 0 36%, transparent 37%),
      radial-gradient(circle at 15% 115%, #13213f 0 38%, transparent 39%),
      radial-gradient(circle at 33% 118%, #142342 0 40%, transparent 41%),
      radial-gradient(circle at 51% 115%, #13203b 0 38%, transparent 39%),
      radial-gradient(circle at 69% 118%, #142342 0 40%, transparent 41%),
      radial-gradient(circle at 87% 112%, #13213f 0 37%, transparent 38%);
