...
<style>
  ...
  position: relative;
  overflow: hidden;
  z-index: 0; /* Create stacking context so ::before/::after with z-index -1 stay visible */
}
...
.page-bg::before {
  ...
  inset: 0;
  background:
    radial-gradient(2px 2px at 20% 30%, rgba(255,255,255,0.8) 60%, transparent),
    radial-gradient(1.5px 1.5px at 70% 20%, rgba(255,255,255,0.8) 60%, transparent),
    radial-gradient(1px 1px at 40% 80%, rgba(255,255,255,0.8) 60%, transparent),
    radial-gradient(1px 1px at 85% 60%, rgba(255,255,255,0.8) 60%, transparent),
    radial-gradient(1px 1px at 30% 70%, rgba(255,255,255,0.8) 60%, transparent),
    radial-gradient(1px 1px at 60% 50%, rgba(255,255,255,0.8) 60%, transparent);
  opacity: 0.6; /* Brighter static stars */
...
.page-bg::after {
  ...
  inset: 0;
  background:
    radial-gradient(1.5px 1.5px at 25% 40%, rgba(255,255,255,0.8), transparent),
  ...
  opacity: 0.55; /* Base brighter, animation takes over */
  filter: drop-shadow(0 0 2px rgba(255,255,255,0.35));
  z-index: -1;
}
