...
<!-- Force dark mode for this page (non-persistent; does not change cookie/localStorage) -->
<script>
  (function(){
    try {
      // Add 'dark' class to the root so Tailwind's dark: variants apply on this page
