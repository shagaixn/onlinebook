...
<main class="bg-gradient-to-b bg-dark from-blue-50 to-white dark:from-slate-950 dark:to-slate-900 min-h-screen py-12 transition-colors duration-300">
  <div class="max-w-4xl mx-auto bg-da dark:bg-slate-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row transition-colors duration-300 border border-gray-200 dark:border-slate-700">
    <!-- Book Image -->
