...
<main class="bg-gray-50 dark:bg-slate-900 min-h-screen py-12 transition-colors duration-300">
    ...
    <div class="max-w-4xl mx-auto rounded-3xl overflow-hidden flex flex-col md:flex-row
                bg-white dark:bg-white/5 backdrop-blur border border-gray-200 dark:border-white/10 shadow-xl transition-colors duration-300">
