  ...
  <h2 class="text-3xl font-extrabold text-slate-900 dark:text-white mb-2 drop-shadow-sm">{{ $book->title }}</h2>
      ...
      <div class="mt-2 flex flex-wrap gap-3">
        ...
        <button aria-label="Худалдан авах"
                class="bg-gradient-to-r from-blue-500 to-indigo-600  dark:text-white px-8 py-3 rounded-full shadow-md hover:from-blue-600 hover:to-indigo-700 transition font-semibold text-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
          Худалдан авах
        </button>
