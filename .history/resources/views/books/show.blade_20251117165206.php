...
<main class=" bg-dark from-blue-50 to-dark dark:from-slate-950 dark:to-slate-900 min-h-screen py-12 transition-colors duration-300">
  <div class="max-w-4xl mx-auto px-6">
    <a href="{{ route('book') }}" class="inline-flex items-center gap-2 text-blue-600 dark:text-blue-300 hover:underline mb-4">
      ← Буцах
    </a>
    <div class="bg-dark dark:bg-slate-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row transition-colors duration-300 border border-gray-200 dark:border-slate-700">
      </div>
    <!-- Book Image -->
