...
<style>
  ...
  background:
    ...
    radial-gradient(circle at 70% 80%, rgba(34,211,238,0.35), transparent 55%),
    radial-gradient(circle at 50% 50%, rgba(168,85,247,0.25), transparent 70%),
    #0b1120;
  position: relative;
  overflow: hidden;
...
.page-bg::before {
  ...
  inset: 0;
  background-image:
    repeating-radial-gradient(circle, white 0 1px, transparent 1px 25px);
  opacity: .25;
  z-index: -1;
}
