...
.page-bg::before {
  ...
  inset: 0;
  background-image:
    repeating-radial-gradient(circle, rgba(255,255,255,0.6) 0 1px, transparent 1px 20px);
  opacity: 0.28;
  z-index: -1;
}

/* different star layer for depth */
.page-bg::after {
  content: "";
  position: absolute;
  inset: 0;
  background-image:
    repeating-radial-gradient(circle, rgba(255,255,255,0.75) 0 1px, transparent 1px 30px);
  opacity: 0.15;
  z-index: -1;
}
