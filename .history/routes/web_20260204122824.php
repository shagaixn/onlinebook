...
// Public book and author lists (guests can view)
Route::get('/book', [HomeController::class, 'book'])->name('book');
Route::get('/authors', [HomeController::class, 'authors'])->name('authors.index');

// Auth / profile
Route::middleware(['auth', 'guest.redirect'])->group(function () {
    // Book details and reading (requires login)
    Route::get('/books/{id}/read', [BookController::class, 'read'])->name('books.read');
    Route::get('/books/{id}', [BookController::class, 'show'])->name('books.show');

    // Author details (requires login)
