...
class AuthorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('layouts.authors.index')->with('success', 'Зохиолч амжилттай нэмэгдлээ.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('layouts.authors.index')->with('success', 'Зохиолч амжилттай шинэчлэгдлээ.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('layouts.authors.index')->with('success', 'Зохиолч устгагдлаа.');
    }
