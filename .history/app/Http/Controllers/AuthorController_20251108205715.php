...
class AuthorController extends Controller
{
    ...
    {
        // Файлын бодит байршилд байгаа Blade файлтай яг таарахаар view()->file ашиглана.
        return view()->file(resource_path('views/layouts/authors/create.blade.php'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // route нэрийг blade дээр ашиглаж байгаа admin.authors.index-т тааруулж засварлав
