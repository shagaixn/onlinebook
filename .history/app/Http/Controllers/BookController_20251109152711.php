...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return back()->withErrors(['author_name' => 'Зохиолч үүсгэхэд алдаа: ' . $e->getMessage()])->withInput();
        }
        ...
        return redirect()->route('layoutsadmin.books.index')->with('success', 'Ном амжилттай нэмэгдлээ!');
    }
