    ...
    public function store(Request $request)
{
    ...
    try {
        ...
        // Redirect (prefer admin route then books.index then fallback)
        ...
        // Fallback to static URL if named routes are missing
        Log::info('Redirecting to /admin/books as fallback');
