...
class AuthorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // prepare DB columns - note: model uses `notable_works` in fillable
        $saveData = [
            'name' => $data['name'],
            'slug' => $data['slug'],
    ...
    'notable_works_text' => $data['notable_works_text'] ?? $author->notable_works_text, // багана байгаа бол
