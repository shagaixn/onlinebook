...
class AuthorController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'awards_text'        => 'nullable|string', // if form sends this; ignored in save below
        ...
        $saveData = [
            ...
            'notable_works_text' => $data['notable_works_text'] ?? null,
    ...
    public function update(Request $request, $id)
    {
        ...
        $updateData = [
            ...
            'notable_works_text' => $data['notable_works_text'] ?? $author->notable_works_text,
