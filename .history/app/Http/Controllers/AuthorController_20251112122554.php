...
class AuthorController extends Controller
{
    ...
    {
        // Only allow layouts.authors.create, otherwise 404
        if (View::exists('layouts.authors.create')) {
            return view('layouts.authors.create');
        }
        abort(404, 'Create view not found. Expected: layouts.authors.create');
    }
    ...
    public function show($slug)
    {
        ...
        return view('layouts.authors.show', compact('authors'));
    }
