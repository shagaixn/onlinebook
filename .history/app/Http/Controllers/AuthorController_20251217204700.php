...
class AuthorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $saveData = [
            ...
            // store notable works into the `notable_works` column (migration uses this)
            'notable_works'      => $data['notable_works_text'] ?? null,
            // convert awards_text (multiline) -> awards (string)
            'awards'             => $this->notableTextToAwards($data['awards_text'] ?? null),
        ];
    ...
    public function update(Request $request, $id)
    {
        ...
        $updateData = [
            ...
            'notable_works'      => $data['notable_works_text'] ?? $author->notable_works,
            'awards'             => $this->notableTextToAwards($data['awards_text'] ?? null) ?? $author->awards,
        ];
