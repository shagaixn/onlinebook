...
<div class="max-w-4xl mx-auto p-6">
    ...
    <form action="{{ route('admin.authors.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 bg-white dark:bg-slate-800 p-6 rounded-lg shadow">
        ...
        <div class="border-b pb-4 mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="url" name="social_facebook" value="{{ old('social_facebook') }}" class="mt-1 block w-full border rounded px-3 py-2 @error('social_facebook') border-red-500 @enderror" placeholder="https://facebook.com/username">
                    @error('social_facebook') <p class="text-sm text-red-600 mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label class="block text-sm font-medium">Twitter/X</label>
                    <input type="url" name="social_twitter" value="{{ old('social_twitter') }}" class="mt-1 block w-full border rounded px-3 py-2 @error('social_twitter') border-red-500 @enderror" placeholder="https://twitter.com/username">
                ...
                <div>
                    ...
                    <input type="url" name="social_instagram" value="{{ old('social_instagram') }}" class="mt-1 block w-full border rounded px-3 py-2 @error('social_instagram') border-red-500 @enderror" placeholder="https://instagram.com/username">
                ...
                <div>
                    ...
                    <input type="url" name="social_linkedin" value="{{ old('social_linkedin') }}" class="mt-1 block w-full border rounded px-3 py-2 @error('social_linkedin') border-red-500 @enderror" placeholder="https://linkedin.com/in/username">
        ...
        <div class="flex items-center gap-4 pt-2">
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition">Хадгалах</button>
            <a href="{{ route('admin.authors.index') }}" class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200">Буцах</a>
        </div>
    </form>
</div>
